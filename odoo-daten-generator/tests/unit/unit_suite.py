...
_MODULES = [
    ...
    ("expenses_unit",      test_expenses_unit.run),
    ("run_config_unit",    test_run_config_unit.run),
    ("run_journal_unit",   test_run_journal_unit.run),
    ...
    # removed RunContext field's kwarg vanished with it) — goldens untouched.
